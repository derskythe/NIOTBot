...
namespace SettingsHelper
{
    public static class SettingsHelpers
    {
            ...
            get
            {
                if (string.IsNullOrWhiteSpace(_BackupAppPath))
                {
                    ...
                    _BackupAppPath = Path.Combine(_DefaultDrive,
                                                  ...
                                                  throw new InvalidOperationException("BackupAppPath cannot be set")
                                                 );
                }
        ...
        private static (bool Success, string OutputMessage) Save(JToken value, string appData, bool? isProduction)
        {
            var success = false;
