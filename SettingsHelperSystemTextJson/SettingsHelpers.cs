...
namespace SettingsHelper
{
    public static class SettingsHelpers
    {
        ...
        private static (bool Success, string OutputMessage) Save(JToken value, string appData)
        {
            var success = false;
        ...
        public static (bool Success, T Value, string OutputMessage) Load<T>()
            where T : SettingsHolderBase, new()
        {
            var outputMessage = new StringBuilder();

            var file = SettingsFileProd;
        ...
        private static List<string> CheckForced(JsonDocument document)
        {
        ...
        // ReSharper disable once UnusedMember.Global
        public static (bool success, string errMsg) AddOrUpdate(this object value, string path)
        {
            var success = false;
        ...
        public static bool IsEqual(this string value, string anotherValue)
        {
            ...
            return value.Equals(anotherValue, StringComparison.InvariantCultureIgnoreCase);
        }
    }
}